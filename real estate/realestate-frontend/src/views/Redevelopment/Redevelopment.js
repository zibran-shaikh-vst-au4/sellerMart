        ...
        <div>
            ...
            <GridContainer justify={'center'}>
                ...
                <CustomButtons variant="contained"
                        ...
                        onClick={handleForm}>Redevelopment<FontAwesomeIcon className='ml-2 mb-2' icon={faPlus} /></CustomButtons>
                    {showing?
                    <Card>
                        <CardHeader color="primary">
                            <h4 className={classes.cardTitleWhite}>Redevelopment</h4>
                            <p className={classes.cardCategoryWhite}>Add details for redevelopment</p>
                        </CardHeader>
                        <CardBody>
                            <GridContainer>
