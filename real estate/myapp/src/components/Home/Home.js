        ...
        return (
            <Fragment>
                ...
                <header id="header">
                        ...
                        <div className="container">
                            <div className="row" style={{ paddingTop: 150 }}>
                                ...
                                <div className="section-title text-center">
                                    <h2 className="m-auto pb-2" style={{ borderBottom: '4px solid #cabe9f', width: '80px' }}>AboutUs</h2>
                                    <p className="about-para col-sm-12 col-md-12 text-center mt-5">
                    ...
                    <div id="project" style={{ backgroundImage: 'url(https://demo2wpopal.b-cdn.net/maisonco/wp-content/uploads/2019/05/landing_bg2.png)', backgroundSize: 'cover', backgroundColor: "#3f4448", height: 1000 }}>
                        <div className="container">
                            <div className="row">
