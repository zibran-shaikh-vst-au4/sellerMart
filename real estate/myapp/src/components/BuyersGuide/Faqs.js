                            ...
                            <div className="faqs-text">
                                <div className="section-title text-center">
                                    ...
                                    <details className="text-justify mt-5">
                                        <summary className="text-justify about-para" style={{ color: '#cabe9f' }}>Q1.What is the difference between Built-Up Area, Super Built-Up Area, and Carpet Area?</summary>
...
Super Built-Up Area: This includes the built-up areas such as the lobby, lifts, stairs etc. This term is therefore only applicable for multi-dwelling units, such as flat complexes</p>
                                    ...
                                    <details className="text-justify">
                                        <summary className="text-justify about-para" style={{ color: '#cabe9f' }}>Q2.What is the difference between the lease agreement and the Leave and License agreement?</summary>
